      ...
      <div className=" relative w-full flex flex-col items-center gap-8">
        <section className="w-full flex flex-col gap-4">
          ...
          <ParagraphStyled>
            ...
            regulan el uso del servicio denominado “Loco por la Cocina” (en
            adelante el “Servicio” o la “Opción de entretenimiento”) ofrecido
            por MOOB MEDIA BUSINESS, C.A (el “Prestador”), por medio de las
            cuales los usuarios de Empresa Operadora S.A. – (en adelante la
            “Operadora”) podrán acceder desde su dispositivo móvil, Tablet,
            laptop o PC, a contenido dedicado al mundo culinario, videos
            exclusivos de recetas, tragos, chefs profesionales, tips de cocina,
            notas editoriales.
          </ParagraphStyled>
        </section>
        <section className=" w-full flex flex-col gap-4">
          <Title2Styled>EL SERVICIO: LOCO POR LA COCINA</Title2Styled>
          <ParagraphStyled>
            Loco por la Cocina es un servicio de entretenimiento que permite
            acceder al cliente, a través de un celular, Tablet o computadora, a
            a contenido dedicado al mundo culinario, videos exclusivos de
            recetas, tragos, chefs profesionales, tips de cocina, notas
            editoriales, en las condiciones que se detallan en estos Términos y
            Condiciones.
          </ParagraphStyled>
          <ParagraphStyled>
            En tal sentido, todos aquellos clientes de la Operadora que así lo
            deseen podrán suscribirse solicitando su alta en la opción de
            entretenimiento mediante el envío de un SMS con el comando que se
            considere como válido para tal acción al número 111 (el precio del
          ...
          <ParagraphStyled>
            ...
            disfrutar sin límites de todo el contenido que ofrece Loco por la
            Cocina. Los cargos por navegación y transmisión de datos no están
            incluidos en el servicio. Los usuarios también podrán suscribirse a
            través de la página web de la Operadora, en la sección opciones de
            entretenimiento digital, seleccionando la opción de Loco por la
            Cocina, a través del URL propio del servicio{' '}
            <Link
          ...
          <ParagraphStyled>
            ...
            baja el usuario debe enviar la palabra BAJA al número 111 y este
          ...
          <ParagraphStyled>
            Loco por la Cocina enviará desde el número 111 un mensaje de texto
            con la información de acceso al portal y el precio al menos una vez
            al mes. Adicionalmente, Loco por la Cocina, enviará al usuario
            mensajes de texto con información relevante en los periodos donde se
            efectúen sorteos, premiaciones y/o actividades de interés para el
            segmento.
          </ParagraphStyled>
          <ParagraphStyled>
            ...
            la página web de la Operadora o del Prestador, con relación al
            Servicio.
          </ParagraphStyled>
        </section>
        <section className=" w-full flex flex-col gap-4">
          ...
          <ParagraphStyled>
            El Servicio está disponible en todo Pais de la Operadora, para toda
            persona física capaz de contratar, cuya línea telefónica móvil se
            encuentre activa al momento de solicitud de ALTA al mismo.
          </ParagraphStyled>
          <ParagraphStyled>
        ...
        <section className=" w-full flex flex-col gap-4">
          ...
          <ParagraphStyled>
            ...
            palabra <span className=" font-semibold">BAJA al número 111</span>.
          </ParagraphStyled>
          <ParagraphStyled>
        ...
        <section className=" w-full flex flex-col gap-4">
          ...
          <ParagraphStyled>
            ...
            las leyes de Pais de la Operadora, renunciando los Usuarios a
            cualquier otra ley a cuya aplicación pudiere tener derecho.
          </ParagraphStyled>
          <ParagraphStyled>
            Estos Términos y Condiciones se rigen por la ley de Pais de la
            Operadora. Para cualquier controversia que pudiera derivarse de la
            prestación de los Servicios o la interpretación y aplicación de los
            Términos y Condiciones, el Prestador y los Usuarios aceptan
            someterse a los tribunales competentes de Pais de la Operadora con
